<div class="col-md-12" style="margin-bottom: 25px;">
	...
	<div class="col-md-9 ad-text-right" style="margin-top: 22px;">
		<a class="btn ad-btn-primary {{ Request::is('questions') ? 'active' : null }}" href="{{ route('questions.index') }}">Question</a>
		...
		<a class="btn ad-btn-primary {{ Request::is('questions/create') ? 'active' : null }}" href="{{ route('questions.create') }}">Ask Questions</a>
	</div>
</div>